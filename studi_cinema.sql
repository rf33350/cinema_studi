...
INSERT INTO cinema_studi.cinema (Name, Address, IdTown, IdAdministrator)  VALUES ('Grand Ecran', '8 Allée des roses', 1, 5);
INSERT INTO cinema_studi.cinema (Name, Address, IdTown, IdAdministrator)  VALUES ('Multiplex', '8 Allée des lilas', 2, 4);
INSERT INTO cinema_studi.cinema (Name, Address, IdTown, IdAdministrator)  VALUES ('Grand Ecran', '8 Allée des acacias', 3, 3);
INSERT INTO cinema_studi.cinema (Name, Address, IdTown, IdAdministrator)  VALUES ('Grand Ecran', '7 Allée des cerisiers', 4, 2);
INSERT INTO cinema_studi.cinema (Name, Address, IdTown, IdAdministrator)  VALUES ('Grand Ecran', '15 Allée des la prairie', 5, 1);
...
CREATE TABLE cinema_studi.room(
	...
	IdCine int,
	FOREIGN KEY (IdCine) REFERENCES cinema_studi.cinema (IdCinema)
)engine=INNODB;

/*remplissage de la table ROOM*/
INSERT INTO cinema_studi.room (Capacity, IdCine) VALUES (250, 1);
INSERT INTO cinema_studi.room (Capacity, IdCine) VALUES (320, 1);
INSERT INTO cinema_studi.room (Capacity, IdCine) VALUES (200, 2);
INSERT INTO cinema_studi.room (Capacity, IdCine) VALUES (50, 2);
INSERT INTO cinema_studi.room (Capacity, IdCine) VALUES (500, 2);
...
INSERT INTO cinema_studi.projection (DateTimeProj, IdCinema, IdMovie, IdRoom) VALUES ('2022-12-31 23:59:59', 1, 1, 1);
INSERT INTO cinema_studi.projection (DateTimeProj, IdCinema, IdMovie, IdRoom) VALUES ('2022-12-22 23:59:59', 1, 1, 1);
INSERT INTO cinema_studi.projection (DateTimeProj, IdCinema, IdMovie, IdRoom) VALUES ('2022-01-31 19:30:10', 1, 2, 1);
INSERT INTO cinema_studi.projection (DateTimeProj, IdCinema, IdMovie, IdRoom) VALUES ('2023-04-17 17:15:00', 2, 3, 1);
INSERT INTO cinema_studi.projection (DateTimeProj, IdCinema, IdMovie, IdRoom) VALUES ('2023-10-11 15:05:00', 2, 4, 1);
...
INSERT INTO cinema_studi.price (Price, Description,IdAdministrator) VALUES (9.20, 'Plein tarif', 1);
INSERT INTO cinema_studi.price (Price, Description,IdAdministrator) VALUES (7.60, 'Etudiant', 1);
INSERT INTO cinema_studi.price (Price, Description,IdAdministrator) VALUES (5.90, 'Moins de 14 ans', 1);
...
CREATE TABLE cinema_studi.place(
	...
	FOREIGN KEY (IdProj) REFERENCES cinema_studi.projection (IdProjection),
	FOREIGN KEY (IdClient) REFERENCES cinema_studi.client (IdClient)
)engine=INNODB;


/*remplissage de la table PLACE*/
INSERT INTO cinema_studi.place (IdPrice, IdProj, IdClient)  VALUES (1, 1, 1);
INSERT INTO cinema_studi.place (IdPrice, IdProj, IdClient)  VALUES (1, 2, 2);
INSERT INTO cinema_studi.place (IdPrice, IdProj, IdClient)  VALUES (1, 3, 5);
INSERT INTO cinema_studi.place (IdPrice, IdProj, IdClient)  VALUES (1, 5, 2);
INSERT INTO cinema_studi.place (IdPrice, IdProj, IdClient)  VALUES (1, 4, 4);